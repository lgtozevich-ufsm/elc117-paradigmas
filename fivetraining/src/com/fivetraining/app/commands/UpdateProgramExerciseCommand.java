...
public class UpdateProgramExerciseCommand extends ConsoleCommand {
    ...
    public UpdateProgramExerciseCommand(UserSession userSession, ExerciseDAO exerciseDAO, ProgramExerciseDAO programExerciseDAO) {
    ...
    public void run(ConsoleInteraction interaction) throws ConsoleCommandExecutionException {
        ...
        try {
            ...
            interaction.getConsole().writeLine("O exercício \"" + exercise.getName() + "\" foi atualizado no programa com sucesso!");
